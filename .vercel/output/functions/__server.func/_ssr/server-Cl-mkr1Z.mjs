...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C60wS3lp.mjs");
...
const manifest = {
  "2a1221af605f33de14fcb3129215421dab3d887ea7a54786b11ee6fc22dd2385": {
    functionName: "adminList_createServerFn_handler",
    importer: () => import("./admin.functions-D0k-kiVg.mjs")
  },
  "3d6294706c0731220b3344c406b834693b02b2eabe60a02d4296a0dfe79b77d1": {
    functionName: "adminSetSetting_createServerFn_handler",
    importer: () => import("./admin.functions-D0k-kiVg.mjs")
  },
  "426e7bfd8bf7784d80defbf7974ae221080d29ae53810d34e72cb03c0cd7fce0": {
    functionName: "getVideoBySlug_createServerFn_handler",
    importer: () => import("./videos.functions-BNVNCkpM.mjs")
  },
  "4ace4570f991c075b5a867d81119d2f45921163af898eb5e7e5fc80a3d7b8e98": {
    functionName: "bootstrapAdminIfNone_createServerFn_handler",
    importer: () => import("./admin.functions-D0k-kiVg.mjs")
  },
  "4ed7a4ded3c2e46db9c8a58b82cb4efcc161e0adfae83f7fec0b2ce245431f71": {
    functionName: "getSiteChrome_createServerFn_handler",
    importer: () => import("./cms.functions-jhX3xDzL.mjs")
  },
  "517f5c10ca4ce444c5e3024b339393d5389496560a0fafe2b6a7ed3d689df1cc": {
    functionName: "adminGetSetting_createServerFn_handler",
    importer: () => import("./admin.functions-D0k-kiVg.mjs")
  },
  "538a3fc5c9b4340cd8685016098fc21a14a7e64d4a43193dab94923c1f7000f8": {
    functionName: "createMediaSignedUrl_createServerFn_handler",
    importer: () => import("./admin.functions-D0k-kiVg.mjs")
  },
  "5cc0279c96364588651386247a894627f23b1528e5a701b5207f2967bcacde82": {
    functionName: "adminUpsert_createServerFn_handler",
    importer: () => import("./admin.functions-D0k-kiVg.mjs")
  },
  ...
  "94c086f20075eea7704418952632703660682c76b793182a33273a52dc27f498": {
    functionName: "getHomepageContent_createServerFn_handler",
    importer: () => import("./cms.functions-jhX3xDzL.mjs")
  },
  "b2f016c286b0a2c85f42701d27078bc0493de51e0688768282a6175b8ee445ae": {
    functionName: "adminReorder_createServerFn_handler",
    importer: () => import("./admin.functions-D0k-kiVg.mjs")
  },
  "b54307ac4d34e95076d59a570cf2390f961b96c0ba131b8afe0ae55ca874601e": {
    functionName: "adminDelete_createServerFn_handler",
    importer: () => import("./admin.functions-D0k-kiVg.mjs")
  },
  "ba0b7809e1b77e99fe78512cb006981a257429e742391e135feb6c7d488997a7": {
    functionName: "getVideoLibrary_createServerFn_handler",
    importer: () => import("./videos.functions-BNVNCkpM.mjs")
  },
  "c43d7092a224db39a5681991f507cf5e7377a72db6dfd80d372622ba7415b77b": {
    functionName: "recordMediaAsset_createServerFn_handler",
    importer: () => import("./admin.functions-D0k-kiVg.mjs")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-EhlbKFja.mjs").then((n) => n.r),
    import("./start-lgp6NWr9.mjs"),
