...
const Church = createLucideIcon("church", __iconNode$y);
const __iconNode$x = [
...
const Cross = createLucideIcon("cross", __iconNode$u);
const __iconNode$t = [
...
const HandHeart = createLucideIcon("hand-heart", __iconNode$p);
const __iconNode$o = [
  [
    "path",
    {
